...
jQuery(document).ready(function(){
	...
	jQuery("#form1").validate({
		...
		messages: {
			NamaProdusen: "Nama Produsen harus diisi.",
                        AlamatProdusen: "Alamat Produsen harus diisi.",
                        NamaKonsumen: "Nama Konsumen harus diisi.",
                        AlamatKonsumen: "Alamat Konsumen harus diisi.",
			Handphone: "Nomor handphone harus diisi.",

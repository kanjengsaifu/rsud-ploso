    ...
    <body>
        ...
        <div class="mainwrapper fullwrapper">
            ...
            <div class="leftpanel">
                ...
                <div class="logopanel">
                    <h1><a href="unitapotik.php?module=home">Inventori Obat</a></h1>
                </div><!--logopanel-->
                ...
                <div class="leftmenu">        
                    <ul class="nav nav-tabs nav-stacked">
                        <li class="<?php if (!isset($_GET['module']) or $_GET['module']=="home" or $_GET['module']==""){echo"active";}else{echo"";}?>"><a href="unitapotik.php?module=home"><span class="iconsweets-home"></span>Beranda</a></li>
                        <li class="<?php $aktif = $_GET['module']=="stok"?"active":""; echo $aktif;?>"><a href="unitapotik.php?module=stokapotik"><span class="iconsweets-dropbox"></span>Stok Obat Terkini</a></li> 
                        <li class="<?php $aktif = $_GET['module']=="transaksimutasiapotik"?"active":""; echo $aktif;?>"><a href="unitapotik.php?module=transaksimutasiapotik"><span class="iconsweets-track"></span>Transaksi Mutasi</a></li>
                        <li class="<?php $aktif = $_GET['module']=="mutasiapotik"?"active":""; echo $aktif;?>"><a href="unitapotik.php?module=mutasiapotik"><span class="iconsweets-dropbox"></span> Rawat Jalan</a></li>
                        <li class="<?php $aktif = $_GET['module']=="mutasiunit"?"active":""; echo $aktif;?>"><a href="unitapotik.php?module=mutasiunit"><span class="iconsweets-dropbox"></span> Rawat Inap</a></li>
                        
                        <li><a href="unitapotik.php?module=pengguna"><span class="icon-wrench"></span>Ubah Sandi</a></li>
                        <li><a href="logout.php"><span class="icon-off"></span>Keluar</a></li>
                        <!--<li class="<?php $aktif = $_GET['module']=="laporankeuangan"?"active":""; echo $aktif;?>"><a href="unitapotik.php?module=laporankeuangan"><span class="iconsweets-money2"></span>Laporan Keuangan & Grafik</a></li>-->
                    </ul>
                </div><!--leftmenu-->

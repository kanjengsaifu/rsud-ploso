...
<script type="text/javascript" src="js/jquery.cookie.js"></script>
    ...
    <body>
        ...
        <div class="mainwrapper fullwrapper">
            ...
            <div class="leftpanel">
                ...
                <div class="logopanel">
                    <h1><a href="admin.php?module=home">Inventori Obat</a></h1>
                </div><!--logopanel-->
                ...
                <div class="leftmenu">        
                    <ul class="nav nav-tabs nav-stacked">
                        <li class="<?php if (!isset($_GET['module']) or $_GET['module']=="home" or $_GET['module']==""){echo"active";}else{echo"";}?>"><a href="admin.php?module=home"><span class="iconsweets-home"></span>Beranda</a></li>
                       
                        <li class="<?php if($_GET['module']=="obat" or $_GET['module']=="unitmutasi" or $_GET['module']=="konsumen"){ echo"active";}else{ echo"";}?> dropdown"><a href="#"><span class="iconsweets-book-large"></span>Manajemen User</a>
                            <ul style="<?php if($_GET['module']=="user" or $_GET['module']=="unitmutasi" ){ echo"display: block;";}else{ echo"";}?>">
                                <li><a href="admin.php?module=user">User</a></li>
                                <!--<li><a href="admin.php?module=produsen">Produsen</a></li>-->
                                <li><a href="admin.php?module=unitmutasi">Unit Mutasi</a></li>
                            </ul>
                        </li>
                        <!--<li class="<?php if($_GET['module']=="transpembelian" or $_GET['module']=="statustranspembelian"){ echo"active";}else{ echo"";}?> dropdown"><a href="#"><span class="iconsweets-cart"></span>Pembelian</a>
                            <ul style="<?php if($_GET['module']=="transpembelian" or $_GET['module']=="statustranspembelian"){ echo"display: block;";}else{ echo"";}?>">
                                <li><a href="admin.php?module=transpembelian">Transaksi Pembelian</a></li>
                                <li><a href="admin.php?module=statustranspembelian">Status Transaksi Pembelian</a></li>
                            </ul>
                        </li>-->
                       <!--  <li class="<?php if($_GET['module']=="transpenjualan" or $_GET['module']=="statustranspenjualan"){ echo"active";}else{ echo"";}?> dropdown"><a href="#"><span class="iconsweets-track"></span>Unit Mutasi</a>
                            ...
                            while ( $rwunit = mysqli_fetch_array($rsunit)) {
                               echo "
                                    <li><a href='admin.php?module=".$rwunit['NamaUnit']."'>".$rwunit['NamaUnit']."</a></li>
                               ";
                            }
    ...
    ?>
                        ...
                        <li class="<?php $aktif = $_GET['module']=="transaksimutasi"?"active":""; echo $aktif;?>"><a href="admin.php?module=transaksimutasi"><span class="iconsweets-track"></span>Transaksi Mutasi</a></li>
                        <li class="<?php $aktif = $_GET['module']=="mutasiapotik"?"active":""; echo $aktif;?>"><a href="admin.php?module=mutasiapotik"><span class="iconsweets-dropbox"></span>Gudang</a></li>
                        <li class="<?php $aktif = $_GET['module']=="mutasiapotik"?"active":""; echo $aktif;?>"><a href="admin.php?module=mutasiapotik"><span class="iconsweets-dropbox"></span>Apotik Rawat Jalan</a></li>
                        <li class="<?php $aktif = $_GET['module']=="mutasiapotik"?"active":""; echo $aktif;?>"><a href="admin.php?module=mutasiapotik"><span class="iconsweets-dropbox"></span>Apotik Rawat Inap</a></li>
                        <li class="<?php $aktif = $_GET['module']=="mutasiunit"?"active":""; echo $aktif;?>"><a href="admin.php?module=mutasiunit"><span class="iconsweets-dropbox"></span>Unit Laboratorium</a></li>
                        <li class="<?php $aktif = $_GET['module']=="mutasiunit"?"active":""; echo $aktif;?>"><a href="admin.php?module=mutasiunit"><span class="iconsweets-dropbox"></span>Instalasi Gawat Darurat</a></li>
                        <li class="<?php $aktif = $_GET['module']=="stok"?"active":""; echo $aktif;?>"><a href="admin.php?module=stok"><span class="iconsweets-dropbox"></span>Stok Terkini</a></li>
                        <li><a href="admin.php?module=pengguna"><span class="icon-wrench"></span>Ubah Sandi</a></li>
                        <li><a href="logout.php"><span class="icon-off"></span>Keluar</a></li>
                        <!--<li class="<?php $aktif = $_GET['module']=="laporankeuangan"?"active":""; echo $aktif;?>"><a href="admin.php?module=laporankeuangan"><span class="iconsweets-money2"></span>Laporan Keuangan & Grafik</a></li>-->
                    </ul>
                </div><!--leftmenu-->
